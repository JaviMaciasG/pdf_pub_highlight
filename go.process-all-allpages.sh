...
#  echo "Processing: $pdf"
  python "$PY_SCRIPT" --output-dir pub --include-all-pages -t "$TEXT_FRAGMENT01" "$TEXT_FRAGMENT02" "$TEXT_FRAGMENT03" "$TEXT_FRAGMENT04" "$TEXT_FRAGMENT05" "$TEXT_FRAGMENT06" "$TEXT_FRAGMENT07" "$TEXT_FRAGMENT08" "$TEXT_FRAGMENT09" "$TEXT_FRAGMENT10" "$TEXT_FRAGMENT11" "$TEXT_FRAGMENT12" "$TEXT_FRAGMENT13" -- "$pdf"
done
